        ...
        <div class="container upper-section p-0 mt-5">
            <div class="row p-4">
                <div class="col-sm-6 p-0">
                    <img class="img-width" src="{{ asset('/') }}uploads/diagnostic/{{empty($info->image)? 'no-image.png' : $info->image}}" alt="">
                </div>
                <div class="col-sm-6 p-0">
                        ...
                        <div class="carousel-inner">
                            @foreach($info->galleryTop as $row)
                                <div class="carousel-item @if($loop->index==0) active @endif">
                                    <img class="img-width" src="{{ asset('/') }}uploads/diagnostic/{{$row->image}}" alt="Los Angeles">
                                </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="container bg-white hospital-dir">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <br>
                    <form action="{{route('diagnosticReviewSubmit')}}" method="post">
                        <input type="hidden" name="diagnostic_id" value="{{$info->id}}">
                    @csrf
                    <div class="section-tab">
                ...
                @php 
                  $reviews = App\DiagnosticReviewsModel::where("diagnostic_id",$info->id);
