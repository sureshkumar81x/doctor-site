        ...
        <div class="container upper-section p-0 mt-5">
            <div class="row p-4">
                <div class="col-sm-6 p-0">
                    <img class="img-width" src="{{ asset('/') }}uploads/doctor/{{empty($info->profile_image)? 'no-image.png' : $info->profile_image}}" alt="">
                </div>
                <div class="col-sm-6 p-0">
                        ...
                        <div class="carousel-inner">
                            @foreach($info->galleryTop as $row)
                                <div class="carousel-item @if($loop->index==0) active @endif">
                                    <img class="img-width" src="{{ asset('/') }}uploads/doctor/{{$row->image}}" alt="Los Angeles">
                                </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="container bg-white doctor-dir">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <br>
                    <form action="{{route('doctorReviewSubmit')}}" method="post">
                ...
                @php 
                  $reviews = App\DoctorsReviewModel::where("doctor_id",$info->id);
