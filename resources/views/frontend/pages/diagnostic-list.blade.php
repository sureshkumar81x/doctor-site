            ...
            <div class="option-card">
                ...
                <div class=" mb-3">
                    <div class="icon-select">
                        ...
                        <select class="form-control input-lg" name="diagnostic_id">
                            <option value="">All Diagnostics</option>
                            @foreach($diagnostic_list as $row)
                               <option value="{{$row->id}}}" @if(!empty(Request::get('diagnostic_id')) && (Request::get('diagnostic_id')==$row->id)) selected @endif>{{$row->name}}</option>
                            @endforeach
                        </select>
                            ...
                            <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <div>
                                                            ...
                                                            <p class="sub-para mt-2">Diagnostics</p>
                                                        </div>
                                                        <div
                                ...
                                <div class="">
                                    <nav aria-label="Page navigation example">
                                        @include('frontend.layouts.pagination',['paginator' => $diagnostics,'params'=>request()->except('page')])
                                    </nav>
                                </div>
                            </div>
                        </div>
