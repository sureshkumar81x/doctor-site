...
@section('title',"Admin : Manage SUb Category")
@section('content')
    <!-- begin #content -->
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage Sub Category</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-xs btn-primary fancybox fancybox.iframe"
                           style="float: right;" href="{{route('admin::addSubCategory',$category_id)}}" title="Add New">
    ...
    @push('scripts')
        <script type="text/javascript">
            $('#Datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('admin::subCategory',$category_id)}}',
                columns: [
            ...
            function status(id, status) {
                $.ajax({
                    type: "post",
                    url: '{{route('admin::statusSubCategory')}}',
                    data: {
