                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            @endif
                            <form class="form-horizontal" action="{{route('admin::updateDoctor',$info->id)}}" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Doctor Address</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Doctor Previous Image</label>
                                        <div class="col-md-6">
                                            <img src="{{url('/')}}/uploads/doctor/{{$info->profile_image}}" width="100px" height="100px" alt="no image" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Doctor Image</label>
                                        <div class="col-md-6">
