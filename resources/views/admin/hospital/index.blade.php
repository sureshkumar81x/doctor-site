...
@section('title',"Admin : Manage Hospital")
@section('content')
    <!-- begin #content -->
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-xs btn-primary fancybox fancybox.iframe"
                           style="float: right;" href="{{route('admin::addHospital')}}" title="Add New">
    ...
    @push('scripts')
        <script type="text/javascript">
            $('#Datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('admin::manageHospital')}}',
                columns: [
            ...
            function status(id, status) {
                $.ajax({
                    type: "post",
                    url: '{{route('admin::hospitalStatus')}}',
                    data: {
